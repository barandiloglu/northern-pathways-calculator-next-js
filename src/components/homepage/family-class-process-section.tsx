...
interface FamilyClassProcessSectionProps {
  lang: Locale
}

export function FamilyClassProcessSection({ lang }: FamilyClassProcessSectionProps) {
  ...
  const steps = [
    {
      step: "1",
      icon: Shield,
      title: t("familyClass.process.eligibilityCheck.title"),
      description: t("familyClass.process.eligibilityCheck.description"),
      buttonText: t("familyClass.cta.button"),
    ...
    },
    {
      step: "2",
      icon: Target,
      title: t("familyClass.process.filePreparation.title"),
      description: t("familyClass.process.filePreparation.description"),
      buttonText: t("familyClass.cta.button"),
      buttonLink: "https://www.northernpathways.ca/pre-assessment-form",
      buttonExternal: true,
    },
    {
      step: "3",
      icon: FileEdit,
      title: t("familyClass.process.submissionSupport.title"),
      description: t("familyClass.process.submissionSupport.description"),
      buttonText: t("familyClass.cta.button"),
      buttonLink: "https://www.northernpathways.ca/pre-assessment-form",
      buttonExternal: true,
    },
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            {t("familyClass.process.title")}
          </h2>
          <p className="text-lg text-white/90 max-w-2xl mx-auto">
            {t("familyClass.process.subtitle")}
          </p>
        </motion.div>
