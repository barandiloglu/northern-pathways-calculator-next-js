...
export function ApplicationProcessSection({ lang }: ApplicationProcessSectionProps) {
  ...
  const steps = [
    {
      ...
      buttonText: t("home.process.step1.button"),
    ...
    },
    {
      ...
      buttonText: t("home.process.step2.button"),
      buttonLink: "https://www.northernpathways.ca/pre-assessment-form",
      buttonExternal: true,
    },
    {
      ...
      buttonText: t("home.process.step3.button"),
      buttonLink: `/${lang}#services`,
