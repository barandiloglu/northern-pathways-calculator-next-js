...
import { Calendar, FileEdit, BookOpen, ArrowRight } from "lucide-react"
import Link from "next/link"
import { type Locale } from "@/lib/i18n-config"
import { getTranslations } from "@/lib/i18n"

interface CitizenshipProcessSectionProps {
  lang: Locale
}

export function CitizenshipProcessSection({ lang }: CitizenshipProcessSectionProps) {
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg text-white/90 max-w-2xl mx-auto">
            A clear, step-by-step approach to your citizenship application
          </p>
        </motion.div>
