...
interface EmployersProcessSectionProps {
  lang: Locale
}

export function EmployersProcessSection({ lang }: EmployersProcessSectionProps) {
  ...
  const steps = [
    {
      step: "1",
      icon: Shield,
      title: t("employers.process.strategySession.title"),
      description: t("employers.process.strategySession.description"),
      buttonText: t("employers.cta.button"),
    ...
    },
    {
      step: "2",
      icon: Target,
      title: t("employers.process.filePreparation.title"),
      description: t("employers.process.filePreparation.description"),
      buttonText: t("employers.cta.button"),
      buttonLink: "https://www.northernpathways.ca/pre-assessment-form",
      buttonExternal: true,
    },
    {
      step: "3",
      icon: FileEdit,
      title: t("employers.process.complianceSupport.title"),
      description: t("employers.process.complianceSupport.description"),
      buttonText: t("employers.cta.button"),
      buttonLink: "https://www.northernpathways.ca/pre-assessment-form",
      buttonExternal: true,
    },
