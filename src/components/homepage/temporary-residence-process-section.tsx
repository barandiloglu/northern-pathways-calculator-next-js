...
interface TemporaryResidenceProcessSectionProps {
  lang: Locale
}

export function TemporaryResidenceProcessSection({ lang }: TemporaryResidenceProcessSectionProps) {
  ...
  const steps = [
    {
      step: "1",
      icon: Shield,
      title: t("temporaryResidence.process.assessment.title"),
      description: t("temporaryResidence.process.assessment.description"),
      buttonText: t("temporaryResidence.cta.button"),
    ...
    },
    {
      step: "2",
      icon: Target,
      title: t("temporaryResidence.process.applicationPrep.title"),
      description: t("temporaryResidence.process.applicationPrep.description"),
      buttonText: t("temporaryResidence.cta.button"),
      buttonLink: "https://www.northernpathways.ca/pre-assessment-form",
      buttonExternal: true,
    },
    {
      step: "3",
      icon: FileEdit,
      title: t("temporaryResidence.process.submissionSupport.title"),
      description: t("temporaryResidence.process.submissionSupport.description"),
      buttonText: t("temporaryResidence.cta.button"),
      buttonLink: "https://www.northernpathways.ca/pre-assessment-form",
      buttonExternal: true,
    },
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            {t("temporaryResidence.process.title")}
          </h2>
          <p className="text-lg text-white/90 max-w-2xl mx-auto">
            {t("temporaryResidence.process.subtitle")}
          </p>
        </motion.div>
