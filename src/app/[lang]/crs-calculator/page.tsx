...
export default function CRSCalculatorPage() {
  ...
  const sections = [
    ...
    ...(isMarriedOrCommonLaw() ? [{ id: "spouse", title: "Spouse Details", icon: Heart, color: "pink", emoji: "❤️" }] : []),
    ...
    ...(isMarriedOrCommonLaw() && isSpouseMoving() ? [{ id: "spouseFactors", title: "Spouse Factors", icon: FileText, color: "teal", emoji: "📋" }] : [])
  ]
