...
export default function FSWPCalculatorPage() {
  ...
  const sections = useMemo(() => [
    ...
    ...(formData.maritalStatus === "married" || formData.maritalStatus === "common_law" ? [{ id: "spouse", title: "Spouse Details", icon: Heart, color: "pink", emoji: "❤️", isNew: true }] : []),
    ...(formData.maritalStatus === "married" || formData.maritalStatus === "common_law") && formData.spouseCitizen === "no" && formData.spouseAccompanying === "yes" ? [{ id: "spouseFactors", title: "Spouse Factors", icon: FileText, color: "teal", emoji: "📋", isNew: true }] : [],
